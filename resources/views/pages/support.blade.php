...
@section('title', ' | Support') {{-- This specific section has it's own title of course and that's home --}}
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-lg-12">
                <h1 class="h1">
                    Contact us <small>It's free of charge <i class="fa fa-smile-o" aria-hidden="true"></i></small></h1>
            </div>
        </div>
    </div>
</div>
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <address>
                <strong>Dimitris Gazis</strong><br>
                <a href="mailto:#">dimitris.gazis@example.com</a>
            </address>
            </form>
        </div>
    </div>
